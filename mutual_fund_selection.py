...
category_rules = {
    ...
    "Moderate Conservative": {"include_category": [ "equity: large cap", "equity: index", "equity: dividend yield", "equity: value"], "aum_min": 10000, "sharpe_weight": 0.25, "sortino_weight": 0.75, "stdev_min": 15.00},
...
stdev_min = st.sidebar.slider(" Standard Deviation",0.0, 45.00, rules['stdev_min'])
